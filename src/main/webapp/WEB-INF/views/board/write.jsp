...
<form method="post" action="write_ok" style="height:100%; width:100%;">
...
<td height=10%>제목</td>
<td  style="text-align:left;"><input type="text" name="title" size="50" style="margin-left:50px;"></td>
</tr>
<tr  style="text-align:center;">
<td style="background:#e9ecef">내용</td>
<td style="text-align:center; background:#f1f3f5;">
<textarea cols="90" rows="20" name="content" ></textarea></td>
<tr  style="text-align:center;">
<td  style=" background:black; border-radius:0px 0px 5px 5px;" height=10% colspan=2>
<input type="submit" style="border:none; background:none; color:white;" value="입력">
